          ...
          <Form className="space-y-4">
            <div>
              <Field 
                ...
                placeholder="Name"
              />
              {touched.name && errors.name && <p className="text-red-500 text-sm mt-1 text-left">{errors.name}</p>}
            </div>
            <div>
              <Field 
                name="email" 
            ...
            <div>
              <Field 
                ...
                type="password"
                className={`w-full p-2 border rounded ${touched.confirmPassword && errors.confirmPassword ? 'border-red-500' : 'border-gray-300'}`}
                placeholder="Confirm Password"
              />
              {touched.confirmPassword && errors.confirmPassword && <p className="text-red-500 text-sm mt-1 text-left">{errors.confirmPassword}</p>}
            </div>
